...
describe('budget', () => {
	...
	describe('fromContract', () => {
		...
		it('should map major head groups in the right order', () => {
			...
			expect(budget.items[2].majorHeadGroup).toBe("Liability (Capital Income)");
			expect(budget.items[3].majorHeadGroup).toBe("Assets (Capital Expenditure)");
		});
